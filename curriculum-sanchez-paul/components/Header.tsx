        ...
        >
           ...
           <motion.div
            ...
            <AnimatePresence>
               {isMenuOpen && (
                    <motion.div
                       initial={{ opacity: 0, y: '-100%' }} // Animación desde arriba
                        animate={{ opacity: 1, y: 0 }}
                        exit={{ opacity: 0, y: '-100%' }} // Animación hacia arriba
                    ...
                    >
                       <nav className="flex flex-col">
                            <motion.div whileHover={{ scale: 1.05, color: '#60a5fa' }} transition={{ duration: 0.2 }}>
                                <Link href="#about" onClick={closeMenu} className="text-gray-300 hover:text-blue-300 py-3 border-b border-gray-700 last:border-b-0">Sobre mí</Link>
                            </motion.div>
                            <motion.div whileHover={{ scale: 1.05, color: '#60a5fa' }} transition={{ duration: 0.2 }}>
                                <Link href="#skills" onClick={closeMenu} className="text-gray-300 hover:text-blue-300 py-3 border-b border-gray-700 last:border-b-0">Habilidades</Link>
                            </motion.div>
                           <motion.div whileHover={{ scale: 1.05, color: '#60a5fa' }} transition={{ duration: 0.2 }}>
                                <Link href="#experience" onClick={closeMenu} className="text-gray-300 hover:text-blue-300 py-3 border-b border-gray-700 last:border-b-0">Experiencia</Link>
                           </motion.div>
                           <motion.div whileHover={{ scale: 1.05, color: '#60a5fa' }} transition={{ duration: 0.2 }}>
                                <Link href="#education" onClick={closeMenu} className="text-gray-300 hover:text-blue-300 py-3 border-b border-gray-700 last:border-b-0">Educación</Link>
                            </motion.div>
                           <motion.div whileHover={{ scale: 1.05, color: '#60a5fa' }} transition={{ duration: 0.2 }}>
                                <Link href="#contact" onClick={closeMenu} className="text-gray-300 hover:text-blue-300 py-3 border-b border-gray-700 last:border-b-0">Contacto</Link>
                            </motion.div>
                       </nav>
                   </motion.div>
               )}
