        ...
        <div className="max-w-3xl mx-auto">
          ...
          <RevealGroup pace="normal" className="grid sm:grid-cols-2 gap-4 sm:gap-6 mb-10">
            {contactInfo.map((info) => (
              <motion.div key={info.text} variants={cardSlide}>
                <SpotlightCard className="surface-card p-6 hover:border-primary-500/40 transition-colors duration-300 h-full">
                  <div className="flex items-start gap-4">
                    <motion.div
                      whileHover={{ rotate: -8, scale: 1.08 }}
                      className="p-3 rounded-xl border border-primary-500/30 bg-primary-500/10 shrink-0"
                    >
          ...
          <Reveal variant="up" className="flex flex-col sm:flex-row items-center justify-center gap-4 text-center">
